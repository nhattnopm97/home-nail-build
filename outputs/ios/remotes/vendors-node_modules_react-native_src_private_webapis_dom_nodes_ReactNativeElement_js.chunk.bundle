(self["webpackChunkminiApp"] = self["webpackChunkminiApp"] || []).push([["vendors-node_modules_react-native_src_private_webapis_dom_nodes_ReactNativeElement_js"], {
...
}]);//# sourceMappingURL=vendors-node_modules_react-native_src_private_webapis_dom_nodes_ReactNativeElement_js.chunk.bundle.map?platform=ios