(self["webpackChunkminiApp"] = self["webpackChunkminiApp"] || []).push([["vendors-node_modules_react-native_Libraries_TurboModule_TurboModuleRegistry_js"], {
...
var BatchedBridge = __webpack_require__(/*! ./BatchedBridge */ "./node_modules/react-native/Libraries/BatchedBridge/BatchedBridge.js");
 ...
 *       strict
 */ 
var MessageQueue = __webpack_require__(/*! ./MessageQueue */ "./node_modules/react-native/Libraries/BatchedBridge/MessageQueue.js");
...
var Systrace = __webpack_require__(/*! ../Performance/Systrace */ "./node_modules/react-native/Libraries/Performance/Systrace.js");
...
var ErrorUtils = __webpack_require__(/*! ../vendor/core/ErrorUtils */ "./node_modules/react-native/Libraries/vendor/core/ErrorUtils.js");
var invariant = __webpack_require__(/*! invariant */ "./node_modules/invariant/browser.js");
var TO_JS = 0;
var TO_NATIVE = 1;
var MODULE_IDS = 0;
       ...
       * this parameters */ return _$module;
        ...
        },
        {
            ...
            value: function callNativeSyncHook(moduleID, methodID, params, onFail, onSucc) {
                if (true) {
                    invariant(__webpack_require__.g.nativeCallSyncHook, 'Calling synchronous methods on native ' + 'modules is not supported in Chrome.\n\n Consider providing alternative ' + 'methods to expose this method in debug mode, e.g. by exposing constants ' + 'ahead-of-time.');
                }
        ...
        },
        {
            ...
            value: function processCallbacks(moduleID, methodID, params, onFail, onSucc) {
                    ...
                    if (true) {
                        ...
                        if (this._successCallbacks.size > 500) {
                            ...
                            this._successCallbacks.forEach((_, callID)=>{
                                ...
                                var _$module = debug && this._remoteModuleTable[debug[0]];
                ...
                if (true) {
                    __webpack_require__.g.nativeTraceBeginAsyncFlow && __webpack_require__.g.nativeTraceBeginAsyncFlow(TRACE_TAG_REACT_APPS, 'native', this._callID);
                }
                this._callID++;
            }
        },
        ...
        },
        {
            ...
            value: function __invokeCallback(cbID, args) {
                ...
                if (true) {
                    ...
                    var _$module = debug && this._remoteModuleTable[debug[0]];
                    var method = debug && this._remoteMethodTable[debug[0]][debug[1]];
                    invariant(callback, `No callback found with cbID ${cbID} and callID ${callID} for ` + (method ? ` ${_$module}.${method} - most likely the callback was already invoked` : `module ${_$module || '<unknown>'}`) + `. Args: '${stringifySafe(args)}'`);
                    var profileName = debug ? '<callback for ' + _$module + '.' + method + '>' : cbID;
...
if (true) {
    ...
    __webpack_require__.g[(__webpack_require__.g.__METRO_GLOBAL_PREFIX__ || '') + '__SYSTRACE'] = Systrace;
}
